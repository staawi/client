...
class L10nKo extends L10n {
  ...
  @override
  String get alwaysUse24HourFormat => '아니요';
  ...
  @override
  String get groupIsPublic => '그룹 채팅 공개됨';
  ...
  @override
  String get noBackupWarning => '경고! 채팅 백업을 켜지 않을경우, 당신은 암호화된 메시지에대한 접근권한을 잃을것입니다. 로그아웃 하기 전에 채팅을 백업하는것이 강력히 권장됩니다.';
  ...
  String fileIsTooBigForServer(String max) {
    return '전송에 실패했습니다. 서버는 $max치가 넘는 파일을 지원하지 않습니다.';
  }
  ...
  @override
  String get changeGeneralChatSettings => '일반 대화 설정 번경하기';

  @override
  String get inviteOtherUsers => '다른 사용자를 이 대화에 초대하기';

  @override
  String get changeTheChatPermissions => '대화 권한 변경하기';

  @override
  String get changeTheVisibilityOfChatHistory => '대화 기록 표시 여부 바꾸기';

  @override
  String get changeTheCanonicalRoomAlias => '메인 공개 대화 주소 변경';

  @override
  String get sendRoomNotifications => '@room 알림 보내기';

  @override
  String get changeTheDescriptionOfTheGroup => '대화의 설명 바꾸기';

  @override
  String get chatPermissionsDescription => '이 대화에서 특정 작업에 필요한 파워 레벨을 정의합니다. 파워 레벨 0, 50, 100은 일반적으로 사용자, 관리자, 관리자를 나타내지만, 모든 등급이 가능합니다.';
  ...
  @override
  String get discoverHomeservers => 'Homeserver 찾아보기';

  @override
  String get whatIsAHomeserver => 'Homeserver(이) 가 무엇인가요?';

  @override
  String get homeserverDescription => '모든 데이터는 이메일 제공자와 마찬가지로 Homeserver(이) 에 저장됩니다. 모든 사람과 여전히 소통할 수 있는 동안 사용하고 싶은 Homeserver(이) 를 선택할 수 있습니다. https://matrix.org에서 자세히 알아보세요.';

  @override
  String get doesNotSeemToBeAValidHomeserver => '호환되는 Homeserver(이) 가 아닌 것 같습니다. URL이 올바르게 입력됐나요?';
  ...
  @override
  String get oneOfYourDevicesIsNotVerified => '당신의 기기 중 하나가 인증되지 않았습니다';

  @override
  String get noticeChatBackupDeviceVerification => '참고: 모든 기기를 대화 백업에 연결하면 자동으로 인증됩니다.';

  @override
  String get continueText => '계속하기';

  @override
  String get welcomeText => '안녕하세요 👋 제 이름은 FluffyChat이에요. 당신은 Htpps://matrix.org에 호환되는 어떤 Homeserver에도 가입할 수 있어요. 그리고 아무나 대화하세요! 저는 큰 대화 네트워크랍니다! 😄';
  ...
  @override
  String get setWallpaper => '배경화면 정하기';

  @override
  String get manageAccount => '계정 관리하기';

  @override
  String get noContactInformationProvided => '서버가 유효한 연락처 정보를 제공하지 않습니다';

  @override
  String get contactServerAdmin => '서버 관리자 연락하기';

  @override
  String get contactServerSecurity => '서버 보안관 연락하기';

  @override
  String get supportPage => '페이지 돕기';
