...
class L10nCs extends L10n {
  ...
  @override
  String get appLockDescription => 'Zamknout aplikaci pomocí PIN kódu když není používána';
  ...
  @override
  String get noChatsFoundHere => 'Nejsou zde žádné chaty. Začněte nový chat s někým, použitím níže uvedeného tlačítka. ⤵️';
  ...
  @override
  String get commandHint_markasdm => 'Označit jako místnost přímé konverzace s daným Matrix ID';
  ...
  @override
  String get defaultPermissionLevel => 'Výchozí úroveň oprávnění nových uživatelů';
  ...
  @override
  String get emoteKeyboardNoRecents => 'Naposledy použité emoce se zobrazí zde...';
  ...
  @override
  String get accessAndVisibilityDescription => 'Kdo se může připojit a najít tuto konverzaci.';
  ...
  @override
  String get customEmojisAndStickersBody => 'Přidat nebo sdílet vlastní emoji nebo nálepky, které mohou být použité v konverzaci.';
  ...
  @override
  String get hideRedactedMessagesBody => 'Pokud někdo zprávu zrediguje, nebude tato zpráva v chatu již viditelná.';

  @override
  String get hideInvalidOrUnknownMessageFormats => 'Skrytí nesprávných nebo neznámých formátů zpráv';
  ...
  @override
  String get blockListDescription => 'Můžete blokovat uživatele, kteří vás obtěžují. Od uživatelů na vašem osobním seznamu blokovaných uživatelů nebudete moci přijímat žádné zprávy ani pozvánky do místnosti.';
  ...
  @override
  String get noChatDescriptionYet => 'Zatím nebyl vytvořen žádný popis konverzace.';
  ...
  @override
  String get redactMessageDescription => 'Tato zpráva bude smazána pro všechny účastníky konverzace. Tuto akci nelze vzít zpět.';
  ...
  @override
  String get dehydrateWarning => 'Tuto akci nelze vzít zpět. Ujistěte se že záložní soubor máte bezpečně uložen.';

  @override
  String get dehydrateTor => 'TOR uživatelé: Export sezení';

  @override
  String get dehydrateTorLong => 'Uživatelům TOR se doporučuje exportovat sezení před zavřením okna.';

  @override
  String get hydrateTor => 'TOR uživatelé: Import exportovaného sezení';

  @override
  String get hydrateTorLong => 'Exportovali jste vaše poslední sezení na TOR? Rychle jej importujte a pokračujte v konverzaci.';
  ...
  @override
  String get hideMemberChangesInPublicChats => 'Skrýt změny členů ve veřejných chatech';

  @override
  String get hideMemberChangesInPublicChatsBody => 'Nezobrazovat na časové ose chatu, pokud se někdo připojí nebo opustí veřejný chat, aby se zlepšila čitelnost.';
  ...
  @override
  String get pleaseEnterRecoveryKeyDescription => 'K odemknutí vašich starých zpráv prosím vložte váš klíč k obnovení vygenerovaný v předchozím sezení. Váš klíč k obnovení NENÍ vaše heslo.';
  ...
  @override
  String get indexedDbErrorLong => 'Ukládání zpráv bohužel není ve výchozím nastavení v soukromém režimu povoleno.\nNavštivte prosím\n - about:config\n - nastavte dom.indexedDB.privateBrowsing.enabled na true\nV opačném případě nebude možné FluffyChat spustit.';
  ...
  @override
  String get storeInSecureStorageDescription => 'Klíč k obnovení uložte v zabezpečeném úložišti tohoto zařízení.';

  @override
  String get saveKeyManuallyDescription => 'Uložte tento klíč manuálně pomocí systémového dialogu sdílení nebo zkopírováním do schránky.';
  ...
  @override
  String get foregroundServiceRunning => 'Toto oznámení se zobrazuje když běží služba na pozadí.';
  ...
  @override
  String get callingAccountDetails => 'Opravňuje FluffyChat používat Android systémovou aplikaci pro vytáčení.';
  ...
  @override
  String get otherCallingPermissions => 'Mikrofon, kamera a ostatní oprávnění FluffyChat';
  ...
  @override
  String get newSpaceDescription => 'Prostory umožňují organizovat vaše konverzace a vytvářet soukromé nebo veřejné komunity';
  ...
  @override
  String get pleaseTryAgainLaterOrChooseDifferentServer => 'Prosím zkuste to znovu nebo si vyberte jiný server.';
  ...
  @override
  String get profileNotFound => 'Uživatel nebyl na serveru nalezen. Možná je problém s připojením nebo uživatel neexistuje.';
